...
typedef struct mtar_t {
	int (*read)(struct mtar_t *tar, void *data, mtar_size_t size);
	int (*write)(struct mtar_t *tar, const void *data, mtar_size_t size);
	int (*seek)(struct mtar_t *tar, mtar_size_t pos);
	int (*close)(struct mtar_t *tar);
	void *stream;
    mtar_mode_t mode;
